    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground font-body">
      <main className="p-10 bg-card rounded-lg shadow-md max-w-2xl text-center">
        <header className="mb-6">
          <h1 className="text-5xl font-bold font-headline text-primary">Blog Page</h1>
          <p className="text-lg text-muted-foreground mt-2">This is a simple, static blog page to get you started.</p>
        </header>

        <section className="my-8">
          <h2 className="text-3xl font-headline font-semibold mb-4">About the Blog</h2>
          <p>
            ...
            <code className="bg-muted px-2 py-1 rounded-md font-code text-sm">src/app/blog/page.tsx</code>.
          </p>
        </section>

        <footer className="mt-8 pt-6 border-t border-border text-sm text-muted-foreground">
          <p>&copy; 2024 Your Application Blog. All rights reserved.</p>
        </footer>
      </main>
    </div>
  );
