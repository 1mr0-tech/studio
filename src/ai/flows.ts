...
2.  **Generate Implementation/Best Practices**: You MUST ALWAYS populate the 'implementation' field for GCP, AWS, and Azure.
    ...
    *   **If the user's question is NOT about implementation**, provide a list of general security best practices and considerations that are relevant to the topic of your answer in the 'implementation' field. For these general best practices, the 'command' field can be a brief note like 'N/A' or a link to relevant documentation.
